...
# heavily base on https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/wan/pipeline_wan.py
...
from ppdiffusers.transformers import AutoTokenizer, UMT5EncoderModel
