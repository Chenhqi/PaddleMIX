...
# 执行评估任务
CUDA_VISIBLE_DEVICES=6 python vbench/run_vbench.py --video_path "$VIDEO_PATH" --save_path "$SAVE_PATH"
CUDA_VISIBLE_DEVICES=6 python vbench/cal_vbench.py --score_dir "$SAVE_PATH"
