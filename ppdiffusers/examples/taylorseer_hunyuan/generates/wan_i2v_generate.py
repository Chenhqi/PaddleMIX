    ...
    with amp.autocast(dtype=self.param_dtype), torch.no_grad(), no_sync():
        ...
        for i, t in enumerate(tqdm(timesteps)):
            ...
            noise_pred_cond = self.model(
                latent_model_input, t=timestep, current_step=current_step, current_stream=current_stream, **arg_c
            ...
            noise_pred_uncond = self.model(
                latent_model_input, t=timestep, current_step=current_step, current_stream=current_stream, **arg_null
            )[0].to(torch.device("cpu") if offload_model else self.device)
