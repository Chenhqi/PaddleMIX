...
from forwards import (
    wan_block_forward,
    wan_firstpredict_step_forward,
    wan_forward,
    wan_pipeline,
    wan_step_forward,
    wan_step_pipeline,
    wan_teacache_forward,
)
...
if __name__ == "__main__":
    ...
    if args.dataset == "vbench":
        with open(
            "/root/paddlejob/workspace/env_run/gxl/paddle_speed/ppdiffusers/examples/taylorseer_hunyuan/vbench/VBench_full_info.json",
            "r",
        ) as f:
        ...
        with open(
            "/root/paddlejob/workspace/env_run/gxl/paddle_speed/ppdiffusers/examples/taylorseer_flux/prompts/prompt.txt",
            "r",
            encoding="utf-8",
        ) as f:
