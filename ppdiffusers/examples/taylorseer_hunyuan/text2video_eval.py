...
for i in range(2):
    ...
    for i in range(0, len(pipe.transformer.hidden_states_list)):
        if i % 2 != 0:
            ...
            dh = (
                pipe.transformer.hidden_states_list[i] - pipe.transformer.hidden_states_list[i - 2]
            ).abs().mean() / pipe.transformer.hidden_states_list[i - 2].abs().mean()
            de = (
                pipe.transformer.hidden_states_first_block[i] - pipe.transformer.hidden_states_first_block[i - 2]
            ).abs().mean() / pipe.transformer.hidden_states_first_block[i - 2].abs().mean()
